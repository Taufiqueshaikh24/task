...
const { getProducts , getProduct, getProductsByCategory , showUpdateProductForm , createProduct, updateProduct, deleteProduct} = require('../controller/products');
...
router.route('/:id/update').get(showUpdateProductForm);
